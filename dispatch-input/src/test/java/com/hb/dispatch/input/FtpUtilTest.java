...
public class FtpUtilTest {
    ...
    public void upload() {
        ...
        ftpUtil.upload("/b/dd/ss/7721/bg.jpg", "/Users/hanbaolaoba/Desktop/aa.jpg", 1024, ftpStreamProgress);
    }
    ...
    public void download() {
        FtpClientFactory ftpClientFactory = new FtpClientFactory("172.19.0.8", 21, "ftpuser", "d9rQyyedLqXiKCUz");
        FtpUtil ftpUtil = new FtpUtil(ftpClientFactory);
        ftpUtil.download("/b/dd/ss/7721/bg.jpg", "/Users/hanbaolaoba/Desktop/cc/dd.jpg", 1024, null);
    }
}
