...
(
    `id`                  bigint                                                  NOT NULL AUTO_INCREMENT,
    `channel`             varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin   NOT NULL COMMENT '渠道',
    `input_platform`      tinyint(1) unsigned NOT NULL COMMENT '输入平台 ',
    `output_platform`     tinyint(1) unsigned NOT NULL COMMENT '输出平台 ',
    ...
    `is_forced_injection` tinyint unsigned NOT NULL DEFAULT '0' COMMENT '是否强制注入 1= 是 0=否',
